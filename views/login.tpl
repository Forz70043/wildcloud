<div class='container-form'>
  ...
  <form class="form-signin" action='login.php' method="POST">
    ...
    [+include file='forms/input.tpl' name='captcha_code' label='' placeholder='write code here' value=''+]
    <div class="form-group col">
      <a href="#" onclick="document.getElementById('captcha').src='../includes/securimage/securimage_show.php?' + Math.random(); return false">
        <span class="fas fa-sync-alt"></span> Reload 
      </a>
    </div>
    [+include file='forms/checkbox.tpl' name="remember" label='Remember me' value=0 required=0 +]
    <button class="btn btn-lg btn-primary btn-block" type="submit" name="send" value="submit">Sign in</button>
